...
alert("iniciando dibujaobjetodesplazado");
...
function rotacionPuntoVector(Vector1, Punto1, anguloAlfa) {
	...
	var PtoUnit = new Punto3D(Vector1.Origen.X + Vector1.X, Vector1.Origen.Y + Vector1.Y, Vector1.Origen.Z + Vector1.Z);
	...
	var PuntoGirado = new Punto3D(VectorResultado.Origen.X + VectorResultado.VX, VectorResultado.Origen.Y + VectorResultado.VY, VectorResultado.Origen.Z + VectorResultado.VZ);
...
function rotacionSistemaCoordenadas(Vector1, SistCoord1, anguloAlfa) {
	...
	var P1 = new Punto3D(SistCoord1.Origen.X + SistCoord1.VectorX.X, SistCoord1.Origen.Y + SistCoord1.VectorX.Y, SistCoord1.Origen.Z + SistCoord1.VectorX.Z);

	var P2 = new Punto3D(SistCoord1.Origen.Y + SistCoord1.VectorY.X, SistCoord1.Origen.Y + SistCoord1.VectorY.Y, SistCoord1.Origen.Z + SistCoord1.VectorY.Z);

	var P3 = new Punto3D(SistCoord1.Origen.X + SistCoord1.VectorZ.X, SistCoord1.Origen.Y + SistCoord1.VectorZ.Y, SistCoord1.Origen.Z + SistCoord1.VectorZ.Z);
